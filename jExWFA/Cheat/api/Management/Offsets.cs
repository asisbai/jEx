...
namespace Managers
{
    ...
    {
        public static int mClient;
        public static int mEngine;

        public static int dwClientState = 0x5A4334;
        public static int dwEntityLoopDistance = 0x10;
        public static int m_bIsDormant = 0xE9;
        public static int GlowObjectOffset = 0x4FA6620;
        public static int m_vecPunch = 0x0000301C;
    }
